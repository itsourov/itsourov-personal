    ...
    return [
        ...
        'bkash' => [
            ...
            'tokenized' => [
                ...
                'createURL' => env('BKASH_TEST_TOKENIZED_API_ROOT') . '/tokenized/checkout/create',
                'executeURL' => env('BKASH_TEST_TOKENIZED_API_ROOT') . '/tokenized/checkout/execute',
                'queryPaymentURL' => env('BKASH_TEST_TOKENIZED_API_ROOT') . '/tokenized/checkout/payment/status',
                'searchTransactionUrl' => env('BKASH_TEST_TOKENIZED_API_ROOT') . '/tokenized/checkout/general/searchTransaction',
                'refundURL' => env('BKASH_TEST_TOKENIZED_API_ROOT') . '/tokenized/checkout/payment/refund',
                'refundStatusURL' => env('BKASH_TEST_TOKENIZED_API_ROOT') . '/tokenized/checkout/payment/refund',
                'tokenURL' => env('BKASH_TEST_TOKENIZED_API_ROOT') . '/tokenized/checkout/token/grant',
            ],
