...
return [
    ...
    */
    ...
    'bkash-tokenized' => [
        'app_key' => env('BKASH_TEST_MODE') ? env('TEST_BKASH_TOKENIZED_APP_KEY') : env('BKASH_TOKENIZED_APP_KEY'),
        'app_secret' => env('BKASH_TEST_MODE') ? env('TEST_BKASH_TOKENIZED_APP_SECRET') : env('BKASH_TOKENIZED_APP_SECRET'),
        'username' => env('BKASH_TEST_MODE') ? env('TEST_BKASH_TOKENIZED_USERNAME') : env('BKASH_TOKENIZED_USERNAME'),
        'password' => env('BKASH_TEST_MODE') ? env('TEST_BKASH_TOKENIZED_PASSWORD') : env('BKASH_TOKENIZED_PASSWORD'),
        'createURL' => (env('BKASH_TEST_MODE') ? env('TEST_BKASH_TOKENIZED_API_ROOT') : env('BKASH_TOKENIZED_API_ROOT')) . '/tokenized/checkout/create',
        'executeURL' => (env('BKASH_TEST_MODE') ? env('TEST_BKASH_TOKENIZED_API_ROOT') : env('BKASH_TOKENIZED_API_ROOT')) . '/tokenized/checkout/execute/',
        'refundURL' => (env('BKASH_TEST_MODE') ? env('TEST_BKASH_TOKENIZED_API_ROOT') : env('BKASH_TOKENIZED_API_ROOT')) . '/tokenized/checkout/payment/refund/',
        'tokenURL' => (env('BKASH_TEST_MODE') ? env('TEST_BKASH_TOKENIZED_API_ROOT') : env('BKASH_TOKENIZED_API_ROOT')) . '/tokenized/checkout/token/grant',
    ],
