            ...
            <x-card class="sm:p-4 md:p-8">
                <article class="prose md:prose-lg prose-zinc dark:prose-invert max-w-none prose-a:text-blue-600">
                    ...
                    <p>This Privacy Policy applies only to our online activities and is valid for visitors to our
                        website with regards to the information that they shared and/or collect in ITSourov. This policy
                    ...
                    <h2>Log Files</h2>
                    <p>ITSourov follows a standard procedure of using log files. These files log visitors when they
                    ...
                    <p>Like any other website, ITSourov uses "cookies". These cookies are used to store information
                    ...
                    <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons
                        that are used in their respective advertisements and links that appear on ITSourov, which are
                    ...
                    <p>Note that ITSourov has no access to or control over these cookies that are used by third-party
                        advertisers.</p>
                    <h2>Third Party Privacy Policies</h2>
                    <p>ITSourov's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
                    ...
                    <p>Another part of our priority is adding protection for children while using the internet. We
                        ...
                        online activity. </p>
                    <p>ITSourov does not knowingly collect any Personal Identifiable Information from children under the
