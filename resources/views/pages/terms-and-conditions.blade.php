        ...
        <div class="container mx-auto px-2">
            <x-card class="sm:p-4 md:p-8">
                <article class="prose md:prose-lg prose-zinc dark:prose-invert max-w-none prose-a:text-blue-600">
                    ...
                    <p>Welcome to ITSourov!</p>

                    <p>These terms and conditions outline the rules and regulations for the use of Sourov Tech's
                        Website, located at https://itsourov.com/.</p>

                    <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
                        ITSourov if you do not agree to take all of the terms and conditions stated on this page.</p>
                    ...
                    <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer
                        ...
                        services, in accordance with and subject to, prevailing law of bd. Any use of the above
                    ...
                    <p>We employ the use of cookies. By accessing ITSourov, you agreed to use cookies in agreement with
                        the Sourov Tech's Privacy Policy. </p>
                    ...
                    <p>Unless otherwise stated, Sourov Tech and/or its licensors own the intellectual property rights
                        for all material on ITSourov. All intellectual property rights are reserved. You may access this
                        from ITSourov for your own personal use subjected to restrictions set in these terms and
                        conditions.</p>

                    <p>You must not:</p>
                    <ul>
                        <li>Republish material from ITSourov</li>
                        <li>Sell, rent or sub-license material from ITSourov</li>
                        <li>Reproduce, duplicate or copy material from ITSourov</li>
                        <li>Redistribute content from ITSourov</li>
                    </ul>

                    <p>Parts of this website offer an opportunity for users to post and exchange opinions and
                        information in certain areas of the website. Sourov Tech does not filter, edit, publish or
                        review Comments prior to their presence on the website. Comments do not reflect the views and
                        opinions of Sourov Tech,its agents and/or affiliates. Comments reflect the views and opinions of
                        the person who post their views and opinions. To the extent permitted by applicable laws, Sourov
                        Tech shall not be liable for the Comments or for any liability, damages or expenses caused
                        and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on
                        this website.</p>

                    <p>Sourov Tech reserves the right to monitor all Comments and to remove any Comments which can be
                    ...
                    <p>You hereby grant Sourov Tech a non-exclusive license to use, reproduce, edit and authorize others
                    ...
                    <p>We will approve link requests from these organizations if we decide that: (a) the link would not
                        ...
                        hyperlink compensates the absence of Sourov Tech; and (d) the link is in the context of general
                    ...
                    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to
                        our website, you must inform us by sending an e-mail to Sourov Tech. Please include your name,
                    ...
                    <p>No use of Sourov Tech's logo or other artwork will be allowed for linking absent a trademark
                        license agreement.</p>
