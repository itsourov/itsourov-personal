...
<div x-show="cartPreview" x-cloak class="fixed inset-0 overflow-hidden z-40" aria-labelledby="slide-over-title"
    ...
    <div class="absolute inset-0 overflow-hidden">
        ...
        <div x-on:click="cartPreview = !cartPreview" x-show="cartPreview" x-transition:enter="ease-in-out duration-500"
        ...
        <div class="fixed inset-y-0 right-0 pl-10 max-w-full flex">
            ...
            <div x-show="cartPreview" x-transition:enter="transform transition ease-in-out duration-500 sm:duration-700"
                                    ...
                                    @foreach ($cartItems as $cartItem)
                                        <li class="py-6 flex">
                                            <div
                                                ...
                                                <img src="{{ $cartItem->media->last()->preview_url }}"
                                            ...
                                            <div class="ml-4 flex-1 flex flex-col">
                                                ...
                                                <div class="flex-1 flex items-end justify-between text-sm">
                                                    ...
                                                    <div class="flex">
                                                        <form action="{{ route('shop.cart.destroy', $cartItem) }}"
                                                            method="post">
                                                            @method('DELETE')
                                                            @csrf
                                                            <input type="hidden" name="cartPreview" value="true">
                                                            <button type="submit"
