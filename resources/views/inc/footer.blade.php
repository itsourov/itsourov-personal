    ...
    <div class="px-2 mx-auto container">
        <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                <img class="w-auto h-9" src="{{ asset('images/logo.png') }}" alt="" />

                <p class="text-base leading-relaxed text-gray-700 dark:text-gray-400 mt-7">Explore the world of
                    technology with
                    {{ config('app.name') }}. Find technical blog posts, digital products, and courses to expand your
                    skills.</p>
            ...
            <div>
                ...
                <ul class="mt-6 space-y-4">
                    ...
                    <li>
                        <x-footer.nav-link :href="route('pages.privacy-policy')">{{ __('Privacy Policy') }}</x-footer.nav-link>
                    </li>
                    <li>
                        <x-footer.nav-link :href="route('pages.terms-and-conditions')">{{ __('Terms and Conditions') }}</x-footer.nav-link>
                    </li>
